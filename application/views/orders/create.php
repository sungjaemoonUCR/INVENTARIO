              ...
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Nombre" autocomplete="off" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Dirección" autocomplete="off">
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Número de contacto</label>
                    <div class="col-sm-7">
                   ...
                   <tbody>
                     <tr id="row_1">
                       <td>
                        ...
                        <td>
                          <input type="text" name="rate[]" id="rate_1" class="form-control" autocomplete="on"></td>
                          <input type="hidden" name="rate_value[]" id="rate_value_1" class="form-control" autocomplete="off">
                        </td>
                        <td>
                          <input type="text" name="amount[]" id="amount_1" class="form-control"autocomplete="on">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label">Impuestos <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
