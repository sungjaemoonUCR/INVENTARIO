          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label">Precio bruto</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Precio Neto</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="net_amount" name="net_amount" value="<?php echo $order_data['order']['net_amount'] ?>" autocomplete="off">
