          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="código" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="price">Precio</label>
                  <input type="text" class="form-control" id="price" name="price" placeholder="Escriba precio" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="qty">Cantidad</label>
                  <input type="text" class="form-control" id="qty" name="qty" placeholder="Digite cantidad" autocomplete="off" />
                </div>
